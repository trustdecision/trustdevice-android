...
class ItemListActivity : BaseActivity<ActivityAppListBinding>() {
    private var mType = 0
    ...
    override fun getViewBinding(): ActivityAppListBinding =
    ...
    override fun initView() {
        ...
        binding.include.setClickListener { view ->
            when (view.id) {
                R.id.tv_title -> finish()
                R.id.tv_title_right -> {
                    mShowSystemApp = !mShowSystemApp
                    if (mShowSystemApp) {
                        binding.include.tvTitleRight.text =
                            resources.getString(R.string.hide_system_apps)
                    } else {
                        binding.include.tvTitleRight.text =
                            resources.getString(R.string.show_system_apps)
                    }
                    loadInstalledAppList(mShowSystemApp)
